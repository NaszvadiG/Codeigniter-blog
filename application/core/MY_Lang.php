...
class MY_Lang extends CI_Lang {
    ...
    */
    ...
    public function default_lang () {
        if (!isset($_COOKIE["lang_choise"])) {
            ...
            echo $_COOKIE["lang_choise"];
            if (array_key_exists($_COOKIE["lang_choise"], $this->languages)) {
                return $_COOKIE["lang_choise"];
            } else {
                reset($this->languages);
                return key($this->languages);
            }
    ...
    * lang configuration to fill other languages gaps.
    * This is very useful
    ...
    *
    *
    * @param boolean $load_first_lang
    *        	false to keep the old behavior. Please
